    ...
    <section class="about-us">
        <div class="contenedor1">
            <h1 class="title">AGROPARTNER S.A.S</h1>
                <br><br>
                <h2> <img src="https://img.icons8.com/ios/50/000000/delete-property.png"/> Eliminar Documento</h2>
                <div class="articulo">
                <form action="">
                ...
                <input class="b2" type="submit" value="Eliminar"> <img src="https://img.icons8.com/office/30/000000/delete--v1.png"/>
                <button class="b2"><a href="index3.php">Regresar</a></button><img src="https://img.icons8.com/color/30/000000/return.png"/>
                <img class="i2" src="images/eliminardoc.jpg" alt="">
                    </form>
