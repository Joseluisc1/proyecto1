    ...
    <section class="about-us">
        <div class="contenedor1">
            <h1 class="title">AGROPARTNER S.A.S</h1>
                <br><br>
                <h2> <img src="https://img.icons8.com/ios-filled/50/000000/small-business.png"/> Crear bodega</h2>
                <div class="articulo">
                <form action="">

                    <p>Nombre<input class="input100" type="text" name=""> <br><br> <br><br><br><br>
                </p>
                <br><br><br><br>
                ...
                <img class="i3" src="images/crearb.jpg" alt="">       
            </form>
