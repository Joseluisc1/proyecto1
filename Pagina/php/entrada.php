    ...
    <section class="about-us">
        <div class="contenedor1">
            <h1 class="title">AGROPARTNER S.A.S</h1>
                <br><br>
                <h2> <img src="https://img.icons8.com/ios-filled/50/000000/woman-opening-door.png"/> Entrada</h2>
                <div class="articulo">
                <form action="">
                    <p class="pp">
                    Fecha<input class="input400" type="date" name=""> <br><br><br><br>
                    Bodega<input class="input100" type="text" name=""> 
                    Producto<input class="input200" type="text" name=""> 
                    Lote<input class="input300" type="text" name="">
                    Cantidad<input class="input500" type="text" name=""> <br><br> <br><br><br><br>
                </p>
                <div class="buttom-center">
                    <div class="buttom-transform">
                        <button class="b3">Agregar</button>
                    </div>
                </div>
                ...
                <br><br><br><br>
                <p class="pp">
                    Observación<input class="input600" type="text" name=""> <br><br><br> <br><br><br>
                </p>
                <input class="b1" type="reset" value="Limpiar"> <img src="https://img.icons8.com/color/30/000000/broom.png"/> 
                <input class="b2" type="submit" class="btn btn-green" value="Enviar Datos"> <img src="https://img.icons8.com/fluency/30/000000/save-close.png"/> 
                <button class="b2"><a href="index2.php">Regresar</a></button><img src="https://img.icons8.com/color/30/000000/return.png"/> 
                <img class="i1" src="images/entradadoc.jpg" alt="">
            </form>
